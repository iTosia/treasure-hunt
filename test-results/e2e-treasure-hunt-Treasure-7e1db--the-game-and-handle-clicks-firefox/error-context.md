...
- Name: e2e/treasure-hunt.spec.ts >> Treasure Hunt Game >> should load the game and handle clicks
- Location: tests/e2e/treasure-hunt.spec.ts:4:3
...
Locator: locator('.play-again-btn')
Expected: visible
Error: strict mode violation: locator('.play-again-btn') resolved to 3 elements:
